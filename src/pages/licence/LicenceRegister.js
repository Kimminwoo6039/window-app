        ...
        <div className="flex flex-col">
            <main className="flex flex-col m-auto justify-center items-center h-screen">
                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    <div className="m-2"></div>
                    <div className="text-[13px] text-neutral-500 w-[271px]">단말기 활성화를 위해 가입한 아이디와 비밀번호,</div>
                    <div className="text-[13px] text-neutral-500 w-[271px] h-[30px]">발급받은 라이선스 등록이 필요합니다.</div>
                </div>
                <div className="m-2"></div>
